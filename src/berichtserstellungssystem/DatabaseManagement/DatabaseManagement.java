...
public class DatabaseManagement {
    ...
    public static void createDataBase () {
        ...
        dialog.setAlwaysOnTop(true);
            SwingWorker<Void,Void> worker = new SwingWorker<Void,Void>()
            {
                ...
                protected Void doInBackground()
                {
                    try {
                        ...
                        JOptionPane.showMessageDialog(dialog, "Veri tabanı oluşturulamadı", "Hatalı İşlem", JOptionPane.PLAIN_MESSAGE);
                    }
                    return null;
                }
            ...
            worker.execute();
            JOptionPane.showMessageDialog(dialog, "Veri tabanı oluşturuluyor, Lütfen Bekleyin!", "Lütfen Bekleyin", JOptionPane.PLAIN_MESSAGE);
